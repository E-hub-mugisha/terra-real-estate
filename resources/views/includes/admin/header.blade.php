...
<style>
    ...
    .t-badge-dot.red   { background: #d94f4f; }
    ...
    .t-notif-icon.land       { background: rgba(208, 82, 8, 0.1); color: #D05208; }
    .t-notif-icon.house      { background: rgba(25, 38, 93, 0.08); color: #19265d; }
    .t-notif-icon.design     { background: rgba(42, 157, 92, 0.1); color: #2a9d5c; }
    .t-notif-icon.agent      { background: rgba(208, 82, 8, 0.08); color: #c06020; }
    .t-notif-icon.consultant { background: rgba(25, 38, 93, 0.06); color: #445580; }
    ...
    .t-notif-type.land       { background: rgba(208, 82, 8, 0.08); color: #D05208; }
    .t-notif-type.house      { background: rgba(25, 38, 93, 0.07); color: #19265d; }
    .t-notif-type.design     { background: rgba(42, 157, 92, 0.08); color: #2a9d5c; }
    .t-notif-type.agent      { background: rgba(208, 82, 8, 0.07); color: #c06020; }
    .t-notif-type.consultant { background: rgba(25, 38, 93, 0.05); color: #445580; }
    ...
    /* ── Dark mode toggle ── */
    .t-theme-btn .sun-icon { display: none; }
    [data-bs-theme="dark"] .t-theme-btn .sun-icon  { display: block; }
    [data-bs-theme="dark"] .t-theme-btn .moon-icon { display: none; }
                    ...
                    @forelse($notifications as $notif)
                        <div class="t-notif-item">
                            <div class="t-notif-icon {{ $notif['type'] }}">
                                @if($notif['type'] === 'land')
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17l4-8 4 5 3-3 4 6H3z"/></svg>
