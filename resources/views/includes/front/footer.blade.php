...
══════════════════════════════════════ */
    ...
    .ab-mv-card.mission .ab-mv-title {
        color: #F0EDE8;
    }

    .ab-mv-card.vision .ab-mv-title {
        color: var(--text);
    }
    ...
    .ab-mv-card.mission .ab-mv-text {
        color: rgba(240, 237, 232, .45);
    }

    .ab-mv-card.vision .ab-mv-text {
        color: var(--muted);
    }
            ...
            <div class="ab-story-text fu2">
                ...
                <div class="ab-values-list">
                    <div class="ab-value-item">
                        <div class="ab-value-dot"><svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="container">
        ...
        <div class="ab-stats-grid">
            <div class="ab-stat-cell">
                <div class="ab-stat-icon"><svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="container">
        ...
        <div class="ab-why-grid">
            <div class="ab-why-card fu">
                <div class="ab-why-icon"><svg viewBox="0 0 24 24" fill="currentColor">
                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg></div>
    ...
    <div class="container">
        ...
        <div class="ab-timeline-track">
            <div class="ab-tl-item">
                ...
                <div class="ab-tl-dot"><svg viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" />
                    </svg></div>
