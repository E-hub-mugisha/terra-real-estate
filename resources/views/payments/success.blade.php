...
<div style="min-height:80vh;display:flex;align-items:center;justify-content:center;padding:3rem 1rem;">
    <div style="max-width:480px;width:100%;text-align:center;">
        ...
        <div style="width:72px;height:72px;background:#D05208;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem;font-size:2rem;">
            ✓
        </div>

        <p style="font-family:'DM Sans',sans-serif;font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:#D05208;margin-bottom:.5rem;">
            Payment Confirmed
        </p>
        ...
        <p style="font-family:'DM Sans',sans-serif;font-size:.9rem;color:#666;line-height:1.7;margin-bottom:2rem;">
            ...
            Reference: <code style="background:#f5f0e8;color:#D05208;padding:.1rem .4rem;border-radius:3px;">{{ $payment->reference }}</code>
        </p>

        @if($payment->payable && $viewRoute)
        <a href="{{ $viewRoute }}"
            style="display:inline-block;background:#D05208;color:#fff;padding:.75rem 2rem;border-radius:4px;font-family:'DM Sans',sans-serif;font-size:.8rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;text-decoration:none;">
            View Listing →
        </a>
        @endif
