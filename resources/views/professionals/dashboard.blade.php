...
<div class="dash-two-col">
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <a href="{{ route('professional.designs.index') }}" class="panel-link">View All →</a>
        </div>

        <div class="design-mini-grid">
            @forelse($recent_designs as $design)
            <a href="{{ route('professional.designs.show', $design) }}" class="design-mini-card">
            ...
            <div class="empty-state-sm" style="grid-column: 1/-1">
                <p>No designs yet. <a href="{{ route('professional.designs.create') }}">Add your first design →</a></p>
            </div>
            @endforelse
        </div>
    </div>
