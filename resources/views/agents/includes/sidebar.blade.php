    ...
    <div class="sidebar-wrapper">
        ...
        <div class="navbar-menu px-5" id="navbar-menu-list" data-simplebar>
            <ul class="list-unstyled p-0 navbar-nav-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-position="right-top" href="{{ route('agent.dashboard.index') }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="collapseeCommerce">
                        <ul class="nav-menu-sub">
                            <li><a href="{{ route('agents.properties.land.index') }}" class="nav-link"><span
                                        data-translate="pe-list-view">Land</span></a></li>
                            <li><a href="{{ route('agents.properties.house.index') }}" class="nav-link"><span
