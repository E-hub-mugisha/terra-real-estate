...
<style>
    ...
    .hp-heading-icon {
        ...
        flex-shrink: 0;
        background: linear-gradient(145deg, #D0520822, #D0520840);
        border: 1px solid #D0520844;
        display: flex;
        align-items: center;
    ...
    .hp-textarea.is-invalid {
        border-color: var(--danger);
        box-shadow: 0 0 0 3px #dc354514;
    }
    ...
    .hp-input-addon.prefix {
        border-right: none;
        border-radius: var(--radius-sm) 0 0 var(--radius-sm);
    }

    .hp-input-addon.suffix {
        border-left: none;
        border-radius: 0 var(--radius-sm) var(--radius-sm) 0;
    }

    .hp-input-group .hp-input.pfx {
        border-radius: 0 var(--radius-sm) var(--radius-sm) 0;
    }

    .hp-input-group .hp-input.sfx {
        border-radius: var(--radius-sm) 0 0 var(--radius-sm);
        border-right: none;
    }
    ...
    .hp-counter input::-webkit-outer-spin-button {
        -webkit-appearance: none;
    }

    .hp-counter input[type=number] {
    ...
    .hp-type-radio:checked+.hp-type-label {
        border-color: var(--accent);
        background: #D052080d;
        color: #8a6830;
    }

    .hp-type-radio:checked+.hp-type-label svg {
        color: var(--accent);
    }
    ...
    .hp-facility-label svg {
        color: var(--muted);
        flex-shrink: 0;
        transition: color .15s;
    }

    .hp-facility-item:checked+.hp-facility-label {
        border-color: var(--accent);
        background: #D052080d;
        color: #8a6830;
        font-weight: 500;
    ...
    .hp-facility-item:checked+.hp-facility-label svg {
        color: var(--accent);
    }
    ...
    .hp-facility-item:checked+.hp-facility-label .hp-facility-check {
    ...
    .hp-btn-primary:hover {
        ...
        box-shadow: 0 4px 12px #D0520844;
    }
    ...
    .qa-modal-head h5 .qa-icon {
        width: 27px;
        height: 27px;
        border-radius: 7px;
        flex-shrink: 0;
        background: linear-gradient(135deg, #D0520822, #D0520840);
        border: 1px solid #D0520844;
        color: var(--accent);
        display: flex;
        align-items: center;
...
<div class="hp-page">
    ...
    <form method="POST" action="{{ route('agent.properties.houses.store') }}" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="e.g. Modern Family Home in Kigali Heights"
                            ...
                            <div class="col-12">
                                ...
                                <div class="hp-type-grid">
                                    ...
                                    'townhouse' => ['label'=>'Townhouse', 'icon'=>'
                                    ...
                                    <input type="radio" name="type" id="type_{{ $val }}" value="{{ $val }}"
                                        class="hp-type-radio"
                                        {{ old('type','house') === $val ? 'checked' : '' }} required>
 ...
 <div class="col-md-6">
                            ...
                            {{-- Bedrooms / Bathrooms / Garages counters --}}
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="bedrooms" id="bedrooms"
                                        value="{{ old('bedrooms', 1) }}" min="0" max="20" required>
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('bedrooms',1)">+</button>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="bathrooms" id="bathrooms"
                                        value="{{ old('bathrooms', 1) }}" min="0" max="20" required>
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('bathrooms',1)">+</button>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="garages" id="garages"
                                        value="{{ old('garages', 0) }}" min="0" max="10">
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('garages',1)">+</button>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="4"
                                    ...
                                    placeholder="Describe the property — finishes, views, nearby amenities…">{{ old('description') }}</textarea>
                ...
                <div id="feeBreakdown" class="p-3 mb-4 rounded border" style="display:none;background:#f8fafc;font-size:.85rem;">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        ...
                        <strong id="fbAgentAmt" style="color:#D05208">—</strong>
                    </div>
                ...
                <div class="hp-submit-bar">
                    <a href="{{ route('agent.properties.houses.index') }}" class="hp-btn hp-btn-ghost">
                        ...
                        <div class="hp-facilities-grid">
                            ...
                            <label for="fac_{{ $facility->id }}" class="hp-facility-label">
                                ...
                                <span class="hp-facility-check">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="3">
                                        <path d="M20 6 9 17l-5-5" />
                                    </svg>
                                </span>
                            </label>
...
<script>
    ...
    function updateCount() {
        ...
        imgCount.textContent = n ? `${n} photo${n > 1 ? 's' : ''} selected` : '';
    }
    ...
    /* ── Tom Select ── (single const, no re-declaration) ── */
    ...
    /* Alias for use inside closures */
    const tomSelect = window.__houseFormTS;

    /* Delegated click for "Register new client" inside Tom Select dropdown */
