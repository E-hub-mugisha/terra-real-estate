...
<div class="lp-page">
    ...
    <div class="lp-heading">
        ...
        <div class="lp-heading-meta">
            ...
            <a href="{{ route('agent.properties.lands.show', $land->id) }}" class="lp-btn lp-btn-ghost" style="padding:.4rem .9rem;font-size:.78rem;">
    ...
    <form method="POST"
          action="{{ route('agent.properties.lands.update', $land->id) }}"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="service_id"
                                class="lp-select @error('service_id') is-invalid @enderror" required>
                            <option value="">Select service</option>
                            @foreach($services as $service)
                                <option value="{{ $service->id }}"
                                    {{ old('service_id', $land->service_id) == $service->id ? 'selected' : '' }}>
                                    {{ $service->title }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="lp-submit-bar">
            ...
            <div class="lp-submit-bar-right">
                <a href="{{ route('agent.properties.lands.index') }}" class="lp-btn lp-btn-ghost">
