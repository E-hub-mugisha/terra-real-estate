...
<style>
    ...
    /* ── Heading ── */
    .ad-heading { display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem; }
    .ad-heading-icon {
    ...
    .ad-input-group .ad-input.sfx { border-radius: 8px 0 0 8px; border-right: none; }
    ...
    .ad-upload-icon {
        width: 46px; height: 46px; border-radius: 10px; background: #c9a96e18;
        display: flex; align-items: center; justify-content: center; margin: 0 auto .75rem; color: var(--accent);
    }
    .ad-upload-zone h6 { font-size: .88rem; font-weight: 600; color: var(--text); margin: 0 0 .25rem; }
    .ad-upload-zone p  { font-size: .77rem; color: var(--muted); margin: 0; }
    .ad-upload-browse { color: var(--accent); font-weight: 500; }

    /* ── File selected state ── */
    .ad-file-selected {
        display: none; align-items: center; gap: .75rem; padding: .85rem 1rem;
        border: 1px solid var(--border); border-radius: 8px; background: #fff; margin-top: .75rem;
    }
    .ad-file-selected.visible { display: flex; }
    .ad-file-type-icon {
        width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center;
        justify-content: center; flex-shrink: 0; font-size: .65rem; font-weight: 700; letter-spacing: .04em;
    }
    ...
    .ad-file-info { flex: 1; min-width: 0; }
    .ad-file-info strong { display: block; font-size: .83rem; color: var(--text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .ad-file-info span   { font-size: .73rem; color: var(--muted); }
    ...
    .ad-img-preview {
        ...
        background: var(--surface); border: 1px solid var(--border); display: none; margin-top: .75rem; position: relative;
    }
    .ad-img-preview.visible { display: block; }
    .ad-img-preview img { width: 100%; height: 100%; object-fit: cover; display: block; }
...
<div class="ad-page">
    ...
    <form method="POST"
          action="{{ route('agent.architectural-designs.store') }}"
        ...
        <div class="ad-layout">
            ...
            <div class="ad-main">
                    ...
                    <div class="ad-card-body">
                        ...
                        <div class="ad-upload-zone" id="designDropzone">
                            ...
                            <div class="ad-upload-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" x2="12" y1="11" y2="17"/><line x1="9" x2="15" y1="14" y2="14"/></svg>
                            </div>
                    ...
                    <div class="ad-card-body">
                        ...
                        <div class="ad-upload-zone" id="previewDropzone">
                            <input type="file" name="preview_image" id="previewImageInput"
                                   accept="image/*">
                            <div class="ad-upload-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
                            </div>
                ...
                <div class="ad-submit-bar">
                    <a href="{{ route('agent.architectural-designs.index') }}" class="ad-btn ad-btn-ghost">
...
previewInput.addEventListener('change', () => { if (previewInput.files[0]) showPreviewImg(previewInput.files[0]); });
...
function showPreviewImg(file) {
    ...
    reader.onload = e => { previewTag.src = e.target.result; previewBox.classList.add('visible'); };
