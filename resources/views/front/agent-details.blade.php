...
.ad-hero h1 em { font-style: italic; color: var(--gold); }
...
/* ── Sidebar ── */
.ad-sidebar { position: sticky; top: 24px; display: flex; flex-direction: column; gap: 16px; }
...
.panel-divider { height: 1px; background: var(--border); margin: 0 20px; }
...
.meta-row svg { width: 14px; height: 14px; color: var(--gold); flex-shrink: 0; }
.meta-row strong { color: var(--text); font-weight: 500; }

/* ── Contact buttons ── */
.contact-stack { display: flex; flex-direction: column; gap: 8px; padding: 16px 20px 20px; }
.c-btn {
    display: flex;
    align-items: center;
...
.c-btn-call   { background: var(--gold-bg); border: 1px solid var(--gold-bd); color: var(--gold); }
.c-btn-call:hover   { background: var(--gold); color: #fff; }
.c-btn-wa     { background: rgba(37,211,102,.1); border: 1px solid rgba(37,211,102,.25); color: #128C7E; }
.c-btn-wa:hover     { background: #25D366; color: #fff; }
.c-btn-email  { background: var(--bg); border: 1px solid var(--border2); color: var(--text); }
.c-btn-email:hover  { background: var(--text); color: #fff; }
...
.ad-tab.on { color: var(--gold); border-bottom-color: var(--gold); }
.ad-tab:hover { color: var(--gold); }

.tab-pane { display: none; padding: 24px 20px; }
.tab-pane.on { display: block; }

/* ── About ── */
.about-text { font-size: .88rem; color: var(--muted); line-height: 1.75; }
.lang-pills { display: flex; gap: 6px; flex-wrap: wrap; margin-top: 14px; }
.lang-pill {
    padding: 4px 12px;
    border-radius: 20px;
    background: var(--bg);
...
.prop-type-badge {
    ...
    background: rgba(200,135,58,.9); color: #fff;
}
.prop-card-body { padding: 12px 14px 14px; flex: 1; display: flex; flex-direction: column; gap: 6px; }
.prop-card-title { font-size: .88rem; font-weight: 600; color: var(--text); line-height: 1.3; }
.prop-card-loc {
    display: flex; align-items: center; gap: 4px;
    font-size: .75rem; color: var(--muted);
}
.prop-card-loc svg { width: 10px; height: 10px; color: var(--gold); flex-shrink: 0; }
.prop-card-price {
    font-size: .92rem; font-weight: 700;
    color: var(--gold); margin-top: auto;
    padding-top: 8px; border-top: 1px solid var(--border);
}
.prop-card-price span { font-size: .72rem; font-weight: 400; color: var(--dim); }
.prop-stats { display: flex; gap: 10px; }
.prop-stat { display: flex; align-items: center; gap: 3px; font-size: .72rem; color: var(--muted); }
.prop-stat svg { width: 11px; height: 11px; }
...
.rstar { width: 14px; height: 14px; color: var(--gold); }
.rstar.empty { color: #D9D4CC; }
.review-card {
    background: var(--bg);
    border: 1px solid var(--border);
    border-radius: 10px;
...
.reviewer-name { font-size: .85rem; font-weight: 600; color: var(--text); }
.review-date   { font-size: .72rem; color: var(--dim); }
.review-text   { font-size: .82rem; color: var(--muted); line-height: 1.65; }
.review-stars-sm { display: flex; gap: 1px; margin-bottom: 6px; }
.rstar-sm { width: 11px; height: 11px; color: var(--gold); }
.rstar-sm.empty { color: #D9D4CC; }
...
<div class="container">
    ...
    <div class="ad-avatar-wrap">
        ...
        <div class="ad-avatar-meta">
            ...
            <p>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style="color:var(--gold)"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/></svg>
            ...
            <div class="panel">
                ...
                <div class="contact-stack">
                    ...
                    <a href="https://wa.me/{{ $agent->whatsapp }}" target="_blank" class="c-btn c-btn-wa">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M11.999 2C6.477 2 2 6.477 2 12c0 1.89.52 3.659 1.428 5.18L2 22l4.975-1.395C8.43 21.51 10.17 22 11.999 22 17.522 22 22 17.523 22 12S17.522 2 11.999 2z"/></svg>
                        WhatsApp
                    </a>
                    @endif
                    @if($agent->email)
