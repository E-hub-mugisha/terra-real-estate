        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                    ...
                    <h1 class="font-lora text-[32px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium"> {{ $agent->full_name }}</h1>
    ...
    <div class="container">
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            ...
            <div class="col-span-12 lg:col-span-3 mb-[30px]">
                <ul class="flex flex-wrap lg:flex-col list-none items-center border-[1px] border-secondary rounded-[8px] h-full text-center px-10 py-[30px] md:py-[50] lg:py-[55px] xl:py-[60px] xl:max-w-[230px] xl:mr-0 md:mr-[20px] ">
                    ...
                    <li class="w-full block">
                        <span class="font-lora text-secondary text-lg"><span class="counter-up">{{ $agent->years_experience }}</span>
                            <span>+</span></span>
            ...
            <div class="col-span-12 md:col-span-7 lg:col-span-5 mb-[30px]">
                <div class="mb-[-30px]">
                    <div class="mb-[30px]">
                        <h3 class="font-lora font-medium text-[28px] text-primary mb-[10px]">Biography<span class="text-secondary">.</span></h3>
                        <p>{{ $agent->bio }}</p>
                        <span class="font-lora font-normal block text-secondary text-[18px] mt-[10px]">
                            Language. </span>
                        <span class="font-lora font-medium text-primary text-[28px]">{{ $agent->languages }}</span>
                        <span class="font-lora font-normal block text-secondary text-[18px] mt-[10px]">
                            Phone no. </span>
                        <a href="tel:+{{ $agent->phone }}" class="font-lora font-medium text-primary text-[28px]">{{ $agent->phone }}</a>
                    </div>
                ...
                <div class="text-center xl:mr-[30px]">
                    <div class="relative rounded-[6px_6px_0px_0px]">
                        <div class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                            <img src="{{ asset('front/assets/images/team/fleming.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" alt="Amelia Margaret" width="197" height="313">
                        </div>
                    </div>
                    ...
                    <div class="drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] bg-primary transition-all duration-700 border-secondary">
                        <h3 class="font-lora font-normal text-[28px] text-white">{{ $agent->full_name}}</h3>
                        <p class="font-normal text-[18px] leading-none capitalize mb-[5px] text-white">{{ $agent->role }}</p>
        ...
        <div class="grid grid-cols-12 gap-x-[30px] xl:gap-x-[55px] mb-[-30px]">
            ...
            <div class="col-span-12 lg:col-span-7 mb-[30px]">
                <h4 class="font-lora text-primary text-[24px] leading-[1.277] sm:text-[28px] capitalize mb-[10px] font-medium">
                    Send Message to {{ $agent->full_name }}<span class="text-secondary">.</span>
                </h4>
    ...
    <div class="container">
        <div class="grid gap-y-[30px] gap-x-[50px]  grid-cols-1 sm:grid-cols-2 md:grid-cols-3  xl:px-[35px]">
            ...
            <div class="relative py-[50px] px-[20px] lg:px-[35px] bg-[#F5F9F8] transition-all drop-shadow-[0px_10px_20px_rgba(0,0,0,0.15)] rounded-[10px]">
                ...
                <a href="tel:{{ $agent->whatsapp }}" class="font-lora text-base text-primary hover:text-secondary">{{ $agent->whatsapp }}</a>
            ...
            <div class="relative py-[50px] px-[20px] lg:px-[35px] bg-[#F5F9F8] transition-all drop-shadow-[0px_10px_20px_rgba(0,0,0,0.15)] rounded-[10px] skew-right">
                <span class="font-lora text-[28px] leading-none text-secondary mb-[15px] block">Location.</span>
                <a href="skype:amelia.margaret" class="font-lora text-base text-primary hover:text-secondary">{{ $agent->office_location }}</a>
