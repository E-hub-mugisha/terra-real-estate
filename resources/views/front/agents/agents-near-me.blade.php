...
@section('title', "Agents near" . {{ $area}})
@section('content')
        ...
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="team-header heading1 space-margin60 text-center">
                    <h5 data-aos="fade-left" data-aos-duration="800" class="aos-init aos-animate">Agents </h5>
            ...
            <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="zoom-out" data-aos-duration="800">
                <div class="team-widget-boxarea">
                    <div class="img1 image-anime">
                        <img src="{{ asset('front/assets/img/all-images/team/team-img1.png') }}" alt="{{ $agent->role }}">
                        <div class="share">
                            <a href="{{ route('front.agent.details', $agent) }}"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                        ...
                        <ul>
                            <li><a href="{{ route('front.agent.details', $agent) }}"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="{{ route('front.agent.details', $agent) }}"><i class="fa-brands fa-linkedin-in"></i></a></li>
                            <li><a href="{{ route('front.agent.details', $agent) }}" class="m-0"><i class="fa-brands fa-instagram"></i></a></li>
                        </ul>
                    </div>
