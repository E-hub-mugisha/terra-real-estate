...
.ar-avatar-upload:hover { border-color: var(--gold); background: var(--gold-bg); }
.ar-avatar-upload input {
    position: absolute; inset: 0; opacity: 0; cursor: pointer; z-index: 2;
}
.ar-avatar-upload svg { width: 32px; height: 32px; color: var(--dim); margin-bottom: 10px; }
.ar-avatar-upload .au-title { font-size: .83rem; color: var(--muted); font-weight: 500; }
.ar-avatar-upload .au-sub   { font-size: .72rem; color: var(--dim); margin-top: 3px; }
.au-preview { display: none; flex-direction: column; align-items: center; gap: 8px; }
.au-preview img {
    width: 88px; height: 88px; border-radius: 50%;
    object-fit: cover; border: 3px solid var(--gold);
}
.au-preview span { font-size: .78rem; color: var(--green); font-weight: 500; }
                    ...
                    <div class="ar-row">
                        <div class="ar-field">
                            ...
                            <select name="district">
                                ...
                                @foreach(['Gasabo','Kicukiro','Nyarugenge','Musanze','Huye','Rubavu','Nyagatare','Rwamagana','Muhanga','Karongi'] as $d)
                ...
                <div class="ar-step" id="step-2">
                    ...
                    <div class="ar-row">
                        <div class="ar-field">
                            ...
                            <div class="ar-si">
                                <svg class="si-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg>
                        ...
                        <div class="ar-field">
                            ...
                            <div class="ar-si">
                                <svg class="si-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
                    ...
                    <div class="ar-row">
                        <div class="ar-field">
                            ...
                            <div class="ar-si">
                                <svg class="si-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
                        ...
                        <div class="ar-field">
                            ...
                            <div class="ar-si">
                                <svg class="si-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
