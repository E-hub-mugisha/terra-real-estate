                    ...
                    <div class="grid grid-cols-12 gap-y-[30px] gap-x-[15px] xl:gap-x-[20px] xl:mr-[30px]">
                        <div class="col-span-7">
                            <a href="assets/images/properties-details/gallery/01.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="assets/images/properties-details/01.png" alt="gallery image" loading="lazy" width="270" height="187">
                            </a>
                        </div>
                        <div class="col-span-5">
                            <a href="assets/images/properties-details/gallery/03.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="assets/images/properties-details/03.png" alt="gallery image" loading="lazy" width="170" height="187">
                            </a>
                        </div>
                        <div class="col-span-5">
                            <a href="assets/images/properties-details/gallery/07.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="assets/images/properties-details/07.png" alt="gallery image" loading="lazy" width="170" height="187">
                            </a>
                        </div>
                        <div class="col-span-7">
                            <a href="assets/images/properties-details/gallery/05.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="assets/images/properties-details/05.png" alt="gallery image" loading="lazy" width="270" height="187">
                            </a>
                        </div>
                    </div>
                    <p class="xl:max-w-[270px] mt-7 xl:mt-0 text-[16px] leading-[2] font-normal">Huge number of propreties availabe here for buy, sell and Rent. Also you find here co-living property, lots opportunity you have to choose here and enjoy huge discount you can get. These cases are perfectly simpl are and easy to distinguish. In a free is hour, when our power of choice is untrammelled and when nothing prev ents our being able to do what we like best, every pleasure is to be welcomed and every pain</p>
                </div>
