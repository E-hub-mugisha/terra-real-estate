            ...
            <div class="col-span-12">
                <div class="max-w-[600px]  mx-auto text-center text-white relative z-[1]">
                    ...
                    <p class="text-base mt-5 max-w-[500px] mx-auto text-center">
                        {{ $land->title}} is a beautiful property located in {{ $land->sector }},{{ $land->district }},{{ $land->province }}.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                ...
                <div class="mt-[45px] mb-[35px]">
                    ...
                    <p>
                        {{ $land->title}} is a beautiful property located in {{ $land->sector }},{{ $land->district }},{{ $land->province }}. It offers stunning views and a peaceful environment, making it an ideal place to build your dream home or invest in real estate. With its spacious land area and convenient location, this property is perfect for those seeking tranquility and natural beauty. Don't miss the opportunity to own this exceptional piece of land and create your own oasis in the heart of nature.
                    </p>
                </div>
                ...
                <h4 class="font-lora text-primary text-[24px] leading-[1.277] sm:text-[28px] capitalize mt-[50px] mb-[40px] font-medium">Land Property Amenities<span class="text-secondary">.</span>
                </h4>
