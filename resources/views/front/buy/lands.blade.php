                        ...
                        <div class="grid grid-cols-1 gap-[30px]">
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties4.jpg" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Elite Garden Resedence.">
                                    </a>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties5.jpg" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="De Parasiya Appartment.">
                                    </a>
                                    ...
                                    <span class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal">for Co-living</span>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties6.png" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Duplex de Villa">
                                    </a>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties7.png" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Orchid Casel de Paradise.">
                                    </a>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties3.png" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Ruposibangla de parlosia.">
                                    </a>
                                    ...
                                    <span class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal">for Rent</span>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties3.png" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Sinomen Studio Palace.">
                                    </a>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties7.png" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Elite Garden Resedence.">
                                    </a>
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="properties-details.html" class="block h-[250px]">
                                        <img src="assets/images/properties/properties8.jpg" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="De Parasiya Appartment.">
                                    </a>
