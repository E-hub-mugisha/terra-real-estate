        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="max-w-[600px]  mx-auto text-center text-white relative z-[1]">
                    <div class="mb-5"><span class="text-base block">Homes for Sale</span></div>
                    <h1 class="font-lora text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium">
                        Homes for Sale<span class="text-secondary">.</span>
                    </h1>

                    <p class="text-base mt-5 max-w-[500px] mx-auto text-center">
                        We have a wide range of properties to suit all needs and budgets, from cozy apartments to spacious family homes.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-[30px]">
                            ...
                            <div class="swiper-slide">
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="{{ route('front.buy.home.details', $home) }}" class="block">
                                            <img src="{{ asset('front/assets/images/properties/properties4.jpg') }}" class="w-full h-full" loading="lazy" width="370" height="266" alt="Elite Garden Resedence.">
                                        </a>
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="{{ route('front.buy.home.details', $home) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">{{ $home->title}}</a></h3>
                                        <h4><a href="{{ route('front.buy.home.details', $home) }}" class="font-light text-[14px] leading-[1.75] underline">{{ $home->address }}</a></h4>
                                        <span class="font-light text-sm">Added: {{ $home->created_at->format('d F, Y') }}</span>
                                        <ul class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            <li class="flex flex-wrap items-center pr-[25px] sm:pr-[5px] md:pr-[25px] border-r border-[#E0DEDE]">
                                                ...
                                                <span>{{ $home->area_sqft}} Sq.fit</span>
                                        ...
                                        <ul>
                                            <li class="flex flex-wrap items-center justify-between">
                                                <span class="font-lora text-base text-primary leading-none font-medium">Price: ${{ number_format($home->price) }}</span>
                        ...
                        <div class="grid grid-cols-1 gap-[30px]">
                            ...
                            <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <a href="{{ route('front.buy.home.details', $home) }}" class="block h-[250px]">
                                        <img src="{{ asset('front/assets/images/properties/properties4.jpg') }}" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="Elite Garden Resedence.">
                                    </a>
                                ...
                                <div class="flex flex-col relative w-full lg:w-[calc(100%-300px)]">
                                    <div class="text-left px-4 lg:px-0 w-full md:w-auto md:flex-1 lg:mr-7 xl:mr-[55px] bg-[#FFFDFC] lg:ml-[30px]">
                                        <h3><a href="{{ route('front.buy.home.details', $home) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary font-medium">{{ $home->title }}</a></h3>
                                        <h4><a href="{{ route('front.buy.home.details', $home) }}" class="font-light text-tiny underline">{{ $home->address }}</a></h4>
                                        <span class="font-light text-sm block">Added: {{ $home->created_at->format('d F, Y') }} </span>
                                        <ul>
                            ...
                            @empty
                            <div class="col-span-12">
                                <p class="text-center text-[#B1AEAE] text-[18px]">No Homes Found</p>
                            </div>
                            @endforelse
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center mb-[40px]">
                                            <div class="relative">
                                                <a href="{{ route('front.buy.home.details', $home) }}" class="block">
                                                    <img src="{{ asset('assets/images/properties/' . $home->image) }}" class="w-full h-full" loading="lazy" width="370" height="266" alt="{{ $home->title }}">
                                                </a>
                                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            ...
                                            <div class="pt-[15px] pb-[20px] px-[20px] text-left">
                                                <h3><a href="{{ route('front.buy.home.details', $home) }}" class="font-lora leading-tight text-[18px] text-primary">{{ $home->title }}</a></h3>
                                                <h4 class="leading-none"><a href="{{ route('front.buy.home.details', $home) }}" class="font-light text-[14px] leading-[1.75] text-primary underline">{{ $home->address }}</a></h4>
                                                <ul class="mt-[10px]">
                                                    <li class="flex flex-wrap items-center justify-between">
                                                        <span class="font-lora text-[14px] text-secondary leading-none">Price: ${{ number_format($home->price) }}</span>
                                        ...
                                        @empty
                                        <p class="text-center text-[14px] text-primary font-light">No Featured Property Found.</p>
                                        @endforelse
                                    </div>
