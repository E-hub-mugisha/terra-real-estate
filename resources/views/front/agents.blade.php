...
<!-- Hero section start -->
<section class="bg-no-repeat bg-center bg-cover bg-[#FFF6F0] h-[350px] lg:h-[513px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-[''] before:bg-[#000000] before:opacity-[70%]" style="background-image: url('front/assets/images/breadcrumb/bg-1.png');">
    <div class="container">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] -mb-[30px]">
            ...
            <div class="text-center group mb-[30px]">
                <div class="relative rounded-[6px_6px_0px_0px]">
                    <a href="{{ route('front.agent.details', $agent) }}" class="block relative">
                ...
                <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-3 md:px-[15px] py-[20px] border-b-[6px] border-primary transition-all duration-500 before:transition-all before:duration-300 group-hover:border-secondary relative">
                    <h3><a href="{{ route('front.agent.details', $agent) }}" class="block relative" class="font-lora font-normal text-base text-primary group-hover:text-secondary">{{ $agent->full_name }}</a></h3>
                    <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-body">{{ $agent->role }} Agent</p>
                </div>
            </div>
            @empty
            <p class="text-center col-span-12 text-secondary">No agents found.</p>
            @endforelse
