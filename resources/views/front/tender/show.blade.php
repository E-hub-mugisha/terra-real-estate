...
<style>
  ...
  .td-hero-badge.open  { background: rgba(34,197,94,.15); color: #4ade80; border: 1px solid rgba(34,197,94,.3); }
  .td-hero-badge.closed{ background: rgba(239,68,68,.15);  color: #f87171; border: 1px solid rgba(239,68,68,.3); }

  .td-hero-badge svg { width: 8px; height: 8px; fill: currentColor; }
  ...
  .td-hero-ref span { color: rgba(255,255,255,.9); font-weight: 600; }
  ...
  .td-card-body { padding: 20px 24px 24px; }
  ...
  .td-meta-icon.gold   { background: rgba(200,135,58,.1);  color: #C8873A; }
  .td-meta-icon.blue   { background: rgba(25,38,93,.08);   color: #19265d; }
  .td-meta-icon.green  { background: rgba(34,197,94,.1);   color: #16a34a; }
  .td-meta-icon.red    { background: rgba(239,68,68,.09);  color: #dc2626; }
  ...
  .td-doc-icon svg { width: 18px; height: 18px; color: #fff; }

  .td-doc-text strong { display: block; font-size: .88rem; font-weight: 700; }
  .td-doc-text span   { font-size: .75rem; color: #6b7280; }

  .td-doc-arrow { margin-left: auto; color: #9ca3af; }
  .td-doc-arrow svg { width: 16px; height: 16px; }
  ...
  .td-owner-avatar svg { width: 22px; height: 22px; color: #fff; }

  .td-owner-info strong { display: block; font-size: .92rem; font-weight: 700; color: #111827; }
  .td-owner-info span   { font-size: .78rem; color: #6b7280; }
  ...
  .td-posted svg { width: 14px; height: 14px; color: #9ca3af; }
  .td-posted strong { color: #374151; font-weight: 600; }
  ...
  .td-apply-btn svg { width: 16px; height: 16px; }
  ...
  .td-share-btn:hover { background: #19265d; color: #fff; }
  .td-share-btn svg   { width: 14px; height: 14px; }
  ...
  .td-breadcrumb a { color: rgba(255,255,255,.45); text-decoration: none; }
  .td-breadcrumb a:hover { color: rgba(255,255,255,.8); }
  .td-breadcrumb svg { width: 10px; height: 10px; }
</style>
...
<div class="td-hero">
  <div class="td-wrap">
    ...
    <div class="td-breadcrumb">
      ...
      <svg viewBox="0 0 24 24" fill="currentColor"><path d="M9 18l6-6-6-6"/></svg>
