...
<style>
    ...
    *::after {
    ...
    .ad-card-img-placeholder svg {
        width: 36px;
        height: 36px;
        color: rgba(200, 135, 58, .4);
    }
    ...
    .ad-s-active {
        background: rgba(30, 122, 90, .75);
        color: #6ee7b7;
    }

    .ad-s-pending {
        background: rgba(180, 140, 10, .75);
        color: #fcd34d;
    }
    ...
    /* ── List view ── */
    .ad-row.list-v .col-xl-3,
    .ad-row.list-v .col-lg-4,
    .ad-row.list-v .col-md-6 {
        flex: 0 0 100%;
        max-width: 100%;
    }

    .ad-row.list-v .ad-card {
        flex-direction: row;
        max-height: 150px;
    }

    .ad-row.list-v .ad-card-img {
        width: 200px;
        min-width: 200px;
        aspect-ratio: unset;
        flex-shrink: 0;
    ...
    .ad-row.list-v .ad-card-body {
        padding: 11px 13px;
    }

    .ad-row.list-v .ad-card-desc {
        display: none;
    }
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-12"
                ...
                <div class="ad-card {{ $isExpired ? 'expired' : '' }}"
                    ...
                    <div class="ad-card-img">
                        ...
                        <img src="{{ asset($ad->images[0]) }}" alt="{{ $ad->title }}" loading="lazy">
                        @else
                    ...
                    <div class="ad-card-body">
                        ...
                        <div class="ad-card-agent">
                            ...
                            <div>
                                <div class="ad-agent-name">{{ $ad->owner_name ?? 'Terra Agent' }}</div>
                                <div class="ad-agent-role">{{ $ad->contact_phone ?? '+250 796 511 725' }}</div>
                            </div>
                        </div>
                        ...
                        <div class="ad-card-foot">
                            ...
                            <a href="{{ route('advertisements.show', $ad) }}" class="ad-card-view">
                                View
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M5 12h14M12 5l7 7-7 7" />
                                </svg>
