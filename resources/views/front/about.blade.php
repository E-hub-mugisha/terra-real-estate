        ...
        <div class="grid grid-cols-12 gap-6 items-center">
            <div class="col-span-12 lg:col-span-6">
                ...
                <div class="scene" data-relative-input="true">
                    <img data-depth="0.1" src="{{ asset('front/assets/images/about/about7.png') }}" class="" loading="lazy" width="729" height="663" alt="about Image">
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px]">
            <div class="relative group">
                <a href="properties-details.html" class="block">
                    <img src="{{ asset('front/assets/images/service/service1.png') }}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Sale Property">
