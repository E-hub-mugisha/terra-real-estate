...
.c-deco-lines { position: absolute; inset: 0; overflow: hidden; opacity: .07; }
.c-deco-lines span {
    display: block; position: absolute;
    height: 1px; background: var(--gold);
}
.c-deco-lines span:nth-child(1) { width: 45%; top: 30%; left: -5%;  transform: rotate(-8deg); }
.c-deco-lines span:nth-child(2) { width: 30%; top: 55%; left: 60%;  transform: rotate(-8deg); }
.c-deco-lines span:nth-child(3) { width: 20%; top: 70%; left: 20%;  transform: rotate(-8deg); }
...
@media (max-width: 860px) {
    .c-grid { grid-template-columns: 1fr; margin-top: -80px; }
}
...
.c-badge--gold { background: var(--gold-pale); color: #7a5a10; }

.c-divider { border: none; border-top: 1px solid var(--border); margin: 18px 0; }
...
/* ─── CTA Buttons ────────────────────────────────── */
.c-cta-stack { display: flex; flex-direction: column; gap: 10px; margin-top: 20px; }
.c-btn {
...
.c-btn--outline:hover { border-color: var(--ink); color: var(--ink); background: var(--surface); }
.c-btn--whatsapp { background: #25D366; color: #fff; }
.c-btn--whatsapp:hover { background: #1ebe5d; color: #fff; }
.c-btn--gold { background: var(--gold); color: var(--ink); font-weight: 700; }
.c-btn--gold:hover { background: #b8922e; }
...
.c-section:hover { box-shadow: var(--shadow-md); }
.c-section-title {
    font-family: 'Cormorant Garamond', serif;
...
@media (max-width: 500px) { .c-contact-grid { grid-template-columns: 1fr; } }
.c-contact-item {
...
.c-contact-item:hover { background: var(--gold-pale); }
.ci-icon {
...
.ci-value { font-size: .85rem; color: var(--ink); font-weight: 500; word-break: break-all; }

/* ─── Social ─────────────────────────────────────── */
.c-social-row { display: flex; flex-wrap: wrap; gap: 10px; }
.c-social-btn {
...
.c-rating-hero .stars { font-size: 1.1rem; color: var(--gold); letter-spacing: 2px; margin-bottom: 4px; }
.c-rating-hero .count { font-size: .8rem; color: var(--muted); }
.c-review-card {
...
.c-review-card:last-child { margin-bottom: 0; }
.c-review-card:hover {
...
.c-reviewer-name { font-weight: 600; font-size: .88rem; }
.c-review-stars  { color: var(--gold); font-size: .88rem; }
.c-review-text   { font-size: .85rem; color: var(--ink-soft); line-height: 1.65; margin: 0; }
...
.c-map-wrap iframe { display: block; }
...
@media (max-width: 768px) { .c-bottom-row { grid-template-columns: 1fr; } }
...
.c-modal .btn-close { filter: invert(1); opacity: .7; }
.c-modal .modal-body { padding: 24px; }
...
.c-input-row { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
            ...
            <div class="c-section">
                ...
                <div class="c-social-row">
                    ...
                    <a href="{{ $consultant->twitter }}" target="_blank" class="c-social-btn">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.261 5.636 5.903-5.636zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        Twitter / X
                    </a>
                    @endif
                </div>
