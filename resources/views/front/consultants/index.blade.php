...
<div class="team1-section-area sp2">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="zoom-out" data-aos-duration="800">
                <div class="team-widget-boxarea">
                    <div class="img1 image-anime">
                        <img src="{{ asset('front/assets/img/all-images/team/team-img1.png') }}" alt="{{ $consultant->role }}">
                        <div class="share">
                            <a href="{{ route('front.consultant.details', $consultant) }}"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                        ...
                        <ul>
                            <li><a href="{{ route('front.consultant.details', $consultant) }}"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="{{ route('front.consultant.details', $consultant) }}"><i class="fa-brands fa-linkedin-in"></i></a></li>
                            <li><a href="{{ route('front.consultant.details', $consultant) }}" class="m-0"><i class="fa-brands fa-instagram"></i></a></li>
                        </ul>
                    </div>
                    <div class="space24"></div>
                    <div class="content-area">
                        <a href="{{ route('front.consultant.details', $consultant) }}">{{ $consultant->name }}</a>
                        <div class="space14"></div>
                        <p>{{ $consultant->title }} &amp; consultant</p>
                    </div>
                </div>
            </div>
            @empty
            <p class="text-center col-span-12 text-secondary">No consultants found.</p>
            @endforelse
        </div>
    </div>
</div>
