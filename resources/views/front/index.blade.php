                        ...
                        <div class="grid grid-cols-12">
                            ...
                            <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                <div class="relative mt-10 -right-6 md:mt-0 lg:absolute lg:right-0 lg:bottom-0 lg:w-3/4 xl:w-fit">
                                    <img class="hero_image w-full" src="{{ asset('front/assets/images/hero/home-1.png') }}" width="866" height="879" alt="hero image">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                            ...
                            <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                <div class="mr-4 self-start shrink-0">
                                    <img src="{{ asset('front/assets/images/icon/location.svg') }}" width="24" height="24" alt="svg icon">
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                <div class="mr-4 self-start shrink-0">
                                    <img src="{{ asset('front/assets/images/icon/property.svg') }}" width="24" height="24" alt="svg icon">
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                <div class="mr-4 self-start shrink-0">
                                    <img src="{{ asset('front/assets/images/icon/dollar-circle.svg') }}" width="24" height="24" alt="svg icon">
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] relative">
                                ...
                                <div class="mr-4 self-start shrink-0">
                                    <img src="{{ asset('front/assets/images/icon/area.svg') }}" width="24" height="24" alt="svg icon">
                                </div>
                                ...
                                <button class="search-btn absolute right-0 lg:right-[-60px] xl:right-[-70px]">
                                    <img src="{{ asset('front/assets/images/icon/search-outline.svg') }}" class="max-w-[30px] xl:w-auto" width="40" height="40" alt="svg icon">
        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="flex flex-col items-center justify-center mb-[50px]">
                    ...
                    <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"> Featured Properties<span class="text-secondary">.</span></h2>
                </div>
            </div>
        </div>
                        ...
                        <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                            <div class="relative">
                                <a href="{{ route('front.buy.home.details', $house->id) }}" class="block">
                                    <img src="{{ asset('front/assets/images/properties/properties1.png') }}" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                </a>
                                ...
                                <span
                                    class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal capitalize">{{ $house->condition }}</span>
                            </div>

                            <div class="py-[20px] px-[20px] text-left">
                                <h3><a href="{{ route('front.buy.home.details', $house->id) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">{{ $house->title }}</a></h3>
                                <h4><a href="{{ route('front.buy.home.details', $house->id) }}" class="font-light text-[14px] leading-[1.75] underline">{{ $house->address }}</a></h4>
                                ...
                                <ul>
                                    <li class="flex flex-wrap items-center justify-between">
                                        <span class="font-lora text-base text-primary leading-none font-medium">Price: ${{ number_format($house->price) }}</span>
        ...
        <div class="grid grid-cols-12 gap-6 items-center">
            <div class="col-span-12 lg:col-span-6">
                ...
                <div class="scene" data-relative-input="true">
                    <img data-depth="0.1" src="{{ asset('front/assets/images/about/about1.png') }}" class="" loading="lazy" width="729" height="663" alt="about Image">
                </div>
            </div>
            <div class="col-span-12 lg:col-span-6 lg:pl-[70px]">
                ...
                <div class="-mb-10 mt-12 xl:mt-[70px] 2xl:mt-[100px]">
                    <div class="flex flex-wrap mb-5 lg:mb-10">
                        <img src="{{ asset('front/assets/images/icon/doller.png') }}" class="self-start mr-5" loading="lazy" width="50" height="50" alt="about Image">
                        <div class="flex-1">
                    ...
                    <div class="flex flex-wrap mb-5 lg:mb-10">
                        <img src="{{ asset('front/assets/images/icon/location.png') }}" class="self-start mr-5" loading="lazy" width="50" height="50" alt="about Image">
                        <div class="flex-1">
                    ...
                    <div class="flex flex-wrap mb-5 lg:mb-10">
                        <img src="{{ asset('front/assets/images/icon/trusted.png') }}" class="self-start mr-5" loading="lazy" width="50" height="50" alt="about Image">
                        <div class="flex-1">
            ...
            <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                ...
                <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                    ...
                    <li data-tab="ForRent" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">For
                            Rent</button></li>
                    <li data-tab="co-living2" class="md:mr-[0px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">Land</button>
                    </li>
                </ul>
            </div>
            <div class="col-span-12">
                        ...
                        <div class="swiper-slide">
                            <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                <div class="relative">
                                    ...
                                    <span
                                        class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal capitalize">{{ $land->land_use }}</span>
                                </div>

                                <div class="py-[20px] px-[20px] text-left">
                                    <h3><a href="{{ route('front.buy.land.details', $land->id) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">{{ $land->title }}</a></h3>
                                    <h4><a href="{{ route('front.buy.land.details', $land->id) }}" class="font-light text-[14px] leading-[1.75] underline">{{ $land->sector }},{{ $land->district }},{{ $land->province }}</a></h4>
                                    ...
                                    <ul>
                                        <li class="flex flex-wrap items-center justify-between">
                                            <span class="font-lora text-base text-primary leading-none font-medium">Price: {{ number_format($land->price) }} RWF</span>
        ...
        <div class="grid grid-cols-12 gap-3 sm:gap-[30px] items-center bg-primary z-[-2] lg:pl-[60px] lg:pr-0 lg:py-0 sm:pl-10 sm:pr-10 pl-5 pr-5 py-5 sm:py-12 rounded-[7px]">
            ...
            <div class="col-span-12 lg:col-span-6 text-center">
                <div class="relative rounded-[24px] lg:pt-[45px] lg:pr-[45px] z-[1] lg:inline-block">
                    <div class="">
                        <img src="{{ asset('front/assets/images/video/shape-3.png') }}" class="absolute top-[30px] right-[30px] z-[-1]" loading="lazy" width="50" height="60" alt="shape image">
                        <img src="{{ asset('front/assets/images/video/shape-2.png') }}" class="absolute left-1/2 hidden lg:block lg:bottom-5 lg:-left-[160px]" loading="lazy" width="128" height="56" alt="Shape">
                    </div>
                    <div class="relative lg:-mb-16">
                        <div class="scene" data-relative-input="true">
                            <img data-depth="0.1" src="{{ asset('front/assets/images/video/video.png') }}" class="rounded-[24px] max-w-full" loading="lazy" width="507" height="349" alt="video image">
                        </div>
                                ...
                                <div class="relative group">
                                    <a href="{{ route('properties.by.district', $district) }}"
                                        ...
                                        <img src="{{ asset('front/assets/images/cities/image2.png') }}"
                                            class="w-full h-[380px] object-cover rounded-[6px]"
                                            alt="{{ $district }}">
...
<section class="testimonial-section pt-[80px] lg:pt-[125px] bg-center bg-no-repeat bg-white z-10">
    <div class="container testimonial-carousel-two relative">
        <div class="scene dots-shape absolute left-0">
            <img data-depth="0.4" class="z-[1]" src="{{ asset('front/assets/images/testimonial/dots.png') }}" width="106" height="129" loading="lazy" alt="shape">
        </div>
                ...
                <div class="swiper rounded-[30px] pb-[40px] md:pb-0">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="pl-[50px] xl:pl-[150px]">
                                <div class="inline-block relative bg-primary text-primary rounded-[30px] z-10">
                                    <img src="{{ asset('front/assets/images/testimonial/person2.png') }}" class="w-auto h-auto block mx-auto relative z-[2] thumb" loading="lazy" width="402" height="505" alt="Oliver Stephen">
                                    <img class="absolute left-[0px] top-0 z-[1]" src="{{ asset('front/assets/images/testimonial/persone-pattern.png') }}" width="400" height="500" loading="lazy" alt="shape">
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="pl-[50px] xl:pl-[150px]">
                                <div class="inline-block relative bg-primary text-primary rounded-[30px] z-10">
                                    <img src="{{ asset('front/assets/images/testimonial/person4.png') }}" class="w-auto h-auto block mx-auto relative z-[2] thumb" loading="lazy" width="402" height="505" alt="Sun Francisco">
                                    <img class="absolute left-[0px] top-0 z-[1]" src="{{ asset('front/assets/images/testimonial/persone-pattern.png') }}" width="400" height="500" loading="lazy" alt="shape">
                                </div>
                            </div>
                ...
                <div class="brand-slider">
                    <div class="swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
                                    <img src="{{ asset('front/assets/images/brand/brand1.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="125" height="109" alt="@@title">
                                </a>
                            </div>
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
                                    <img src="{{ asset('front/assets/images/brand/brand2.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="125" height="109" alt="@@title">
                                </a>
                            </div>
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
                                    <img src="{{ asset('front/assets/images/brand/brand3.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="125" height="109" alt="@@title">
                                </a>
                            </div>
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
                                    <img src="{{ asset('front/assets/images/brand/brand4.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="125" height="109" alt="@@title">
                                </a>
                            </div>
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
                                    <img src="{{ asset('front/assets/images/brand/brand5.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="125" height="109" alt="@@title">
                                </a>
                            </div>
                            <div class="swiper-slide text-center">
                                <a href="#" class="block">
            ...
            <div class="text-center group mb-[30px]">
                <div class="relative rounded-[6px_6px_0px_0px]">
                    <a href="{{ route('front.agent.details', $agent) }}">
                        <img src="{{ asset('front/assets/images/team/person1.png') }}" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="{{ $agent->full_name }}">
                    </a>
                ...
                <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-3 md:px-[15px] py-[20px] border-b-[6px] border-primary transition-all duration-500 before:transition-all before:duration-300 group-hover:border-secondary relative">
                    <h3><a href="{{ route('front.agent.details', $agent) }}" class="font-lora font-normal text-base text-primary group-hover:text-secondary">{{ $agent->full_name }}</a></h3>
                    <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-body">Real Estate {{ $agent->user->role }}</p>
                </div>
            </div>
            @empty
            <p>No Agent Found</p>
                ...
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="w-full hidden lg:block lg:w-auto mt-5 lg:mt-0">
                        <div class="relative mt-10 md:mt-0 lg:absolute lg:right-0 lg:bottom-0">
                            <img class="hero_image lg:max-w-[550px] xl:max-w-[650px] 2xl:max-w-[714px]" src="{{ asset('front/assets/images/newsletter/bg-1.png') }}" width="866" height="879" alt="hero image">
                        </div>
                    </div>
                </div>
