...
.nd-bc-inner a { color: var(--muted); transition: color var(--t); }
.nd-bc-inner a:hover { color: var(--gold); }
.nd-bc-inner svg { width: 12px; height: 12px; }
.nd-bc-inner .cur { color: var(--text); font-weight: 500; }
...
.nd-hero .container { position: relative; z-index: 2; max-width: 820px; }
...
.nd-cat-badge {
    ...
    letter-spacing: .09em; text-transform: uppercase; color: var(--gold-lt);
    margin-bottom: 14px;
}
.nd-hero h1 {
...
.nd-meta-item {
    ...
    font-size: .76rem; color: rgba(240,237,232,.4);
}
.nd-meta-item svg { width: 13px; height: 13px; color: var(--gold-lt); flex-shrink: 0; }
.nd-meta-item strong { color: rgba(240,237,232,.65); font-weight: 500; }
.nd-meta-dot { width: 3px; height: 3px; border-radius: 50%; background: rgba(255,255,255,.2); }

/* Hero cover image */
.nd-cover {
    margin-top: 40px; border-radius: 16px; overflow: hidden;
    aspect-ratio: 21/9; background: var(--bg);
}
.nd-cover img { width: 100%; height: 100%; object-fit: cover; display: block; }
@media (max-width: 640px) { .nd-cover { aspect-ratio: 16/9; } }

/* ── Page layout ── */
.nd-page { padding: 40px 0 80px; }
.nd-layout {
    display: grid;
    grid-template-columns: 1fr 300px;
    gap: 28px; align-items: start;
}
@media (max-width: 900px) { .nd-layout { grid-template-columns: 1fr; } .nd-sidebar { order: -1; } }
...
@media (max-width: 640px) { .nd-article-body { padding: 22px 18px; } }
...
.nd-toolbar-left svg { width: 13px; height: 13px; color: var(--gold); }
.nd-share-group { display: flex; align-items: center; gap: 6px; }
.nd-share-label { font-size: .72rem; color: var(--dim); font-weight: 500; }
.nd-share-btn {
...
.nd-share-btn:hover { background: var(--gold); border-color: var(--gold); color: #fff; }
.nd-share-btn svg { width: 13px; height: 13px; }

/* Prose styles */
.nd-prose { font-size: .92rem; color: var(--muted); line-height: 1.9; }
.nd-prose h2 {
    font-family: 'Cormorant Garamond', serif;
...
.nd-prose p { margin-bottom: 1.2rem; }
.nd-prose p:last-child { margin-bottom: 0; }
.nd-prose strong { color: var(--text); font-weight: 600; }
.nd-prose a { color: var(--gold); text-decoration: underline; text-decoration-color: var(--gold-bd); }
.nd-prose a:hover { text-decoration-color: var(--gold); }
.nd-prose ul, .nd-prose ol { padding-left: 1.4rem; margin-bottom: 1.2rem; }
.nd-prose li { margin-bottom: .4rem; }
.nd-prose blockquote {
    margin: 1.6rem 0; padding: 16px 20px;
...
.nd-prose img {
    width: 100%; border-radius: var(--r); margin: 1.4rem 0; display: block;
}
...
.nd-author-av {
    ...
    background: var(--gold-bg); border: 2px solid var(--gold-bd);
    display: grid; place-items: center;
    font-family: 'Cormorant Garamond', serif;
    font-size: 1.1rem; font-weight: 600; color: var(--gold); flex-shrink: 0;
}
.nd-author-name {
    font-size: .9rem; font-weight: 600; color: var(--text); margin-bottom: 2px;
}
.nd-author-role { font-size: .75rem; color: var(--dim); }
.nd-author-bio  { font-size: .78rem; color: var(--muted); line-height: 1.65; margin-top: 5px; }

/* ── SIDEBAR ── */
.nd-sidebar { position: sticky; top: 24px; display: flex; flex-direction: column; gap: 16px; }
...
.nd-panel-icon svg { width: 13px; height: 13px; color: var(--gold); }
.nd-panel-title {
    font-family: 'Cormorant Garamond', serif;
    font-size: .95rem; font-weight: 600; color: var(--text); margin: 0;
}
.nd-panel-body { padding: 14px 16px; }
...
.nd-sb-search input:focus { outline: none; border-color: var(--gold); background: var(--surface); }
.nd-sb-search input::placeholder { color: var(--dim); }
.nd-sb-search button {
    position: absolute; right: 8px; top: 50%; transform: translateY(-50%);
    background: none; border: none; cursor: pointer; color: var(--gold);
}
.nd-sb-search button svg { width: 14px; height: 14px; display: block; }

/* Categories */
.nd-cat-list { display: flex; flex-direction: column; gap: 3px; }
.nd-cat-item {
    display: flex; align-items: center; justify-content: space-between;
...
.nd-cat-item:hover { background: var(--gold-bg); color: var(--gold); }
.nd-cat-item:hover .nd-cat-count { background: var(--gold); color: #fff; border-color: var(--gold); }
.nd-cat-name { display: flex; align-items: center; gap: 6px; }
.nd-cat-name svg { width: 11px; height: 11px; color: var(--gold); }
.nd-cat-count {
...
.nd-rel-item:hover { transform: translateX(3px); }
.nd-rel-img {
    width: 64px; height: 52px; border-radius: 7px; overflow: hidden;
    background: var(--bg); flex-shrink: 0;
}
.nd-rel-img img { width: 100%; height: 100%; object-fit: cover; display: block; }
.nd-rel-date {
...
.nd-related-section { padding: 0 0 72px; }
.nd-related-head {
    display: flex; align-items: center; justify-content: space-between;
...
.nd-related-title em { font-style: italic; color: var(--gold); }
.nd-see-all {
    display: inline-flex; align-items: center; gap: 5px;
    font-size: .78rem; color: var(--gold); font-weight: 500;
    border-bottom: 1px solid var(--gold-bd); transition: gap var(--t);
}
.nd-see-all:hover { gap: 9px; }
.nd-see-all svg { width: 12px; height: 12px; }
...
.nd-rel-card:hover {
    transform: translateY(-4px); border-color: var(--gold-bd);
    box-shadow: 0 10px 28px rgba(0,0,0,.09); color: var(--text);
}
.nd-rel-card-img { position: relative; aspect-ratio: 16/10; overflow: hidden; background: var(--bg); flex-shrink: 0; }
.nd-rel-card-img img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform .5s ease; }
.nd-rel-card:hover .nd-rel-card-img img { transform: scale(1.06); }
.nd-rel-card-cat {
...
.nd-rel-card-body { padding: 13px 14px 15px; display: flex; flex-direction: column; gap: 7px; flex: 1; }
.nd-rel-card-meta { font-size: .7rem; color: var(--dim); }
.nd-rel-card-title {
    font-family: 'Cormorant Garamond', serif;
...
.nd-rel-card-author { display: flex; align-items: center; gap: 6px; font-size: .72rem; color: var(--muted); }
.nd-rel-av {
...
.nd-rel-readmore {
    ...
    font-size: .72rem; font-weight: 600; color: var(--gold); transition: gap var(--t);
}
.nd-rel-card:hover .nd-rel-readmore { gap: 7px; }
.nd-rel-readmore svg { width: 11px; height: 11px; }

/* ── CTA ── */
.nd-cta {
    background: var(--dark); position: relative; overflow: hidden; padding: 64px 0;
}
.nd-cta::before {
    content: '';
    position: absolute; inset: 0;
...
.nd-cta .container { position: relative; z-index: 2; }
.nd-cta-inner { display: flex; align-items: center; justify-content: space-between; gap: 40px; flex-wrap: wrap; }
.nd-cta-eyebrow {
    font-size: .68rem; font-weight: 600; letter-spacing: .12em;
    text-transform: uppercase; color: var(--gold-lt); margin-bottom: 8px; display: block;
}
.nd-cta-title {
    font-family: 'Cormorant Garamond', serif;
...
.nd-cta-title em { font-style: italic; color: var(--gold-lt); }
.nd-cta-sub { font-size: .84rem; color: rgba(240,237,232,.38); line-height: 1.75; margin-top: 8px; max-width: 420px; }
.nd-cta-btns { display: flex; gap: 10px; flex-wrap: wrap; flex-shrink: 0; }
.nd-cta-btn {
...
.nd-cta-btn svg { width: 14px; height: 14px; }
.nd-btn-gold  { background: var(--gold); color: #fff; }
.nd-btn-gold:hover  { background: #a06828; color: #fff; transform: translateY(-1px); }
.nd-btn-ghost { background: rgba(255,255,255,.08); color: #F0EDE8; border: 1px solid rgba(255,255,255,.15); }
...
<div class="container">
        ...
        <aside class="nd-sidebar">
            ...
            <div class="nd-panel">
                <div class="nd-panel-head">
                    <div class="nd-panel-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z"/></svg></div>
                    <p class="nd-panel-title">Search Articles</p>
                </div>
                <div class="nd-panel-body">
                    <form action="{{ route('front.news') }}" method="GET" class="nd-sb-search">
            ...
            <div class="nd-panel">
                <div class="nd-panel-head">
                    <div class="nd-panel-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.5 2C6.81 2 3 5.81 3 10.5S6.81 19 11.5 19h.5v3c4.86-2.34 8-7 8-11.5C20 5.81 16.19 2 11.5 2zm1 14.5h-2v-2h2v2zm0-4h-2c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 2.5-3 2.75-3 5z"/></svg></div>
                    <p class="nd-panel-title">Categories</p>
                </div>
                <div class="nd-panel-body">
                    <div class="nd-cat-list">
                        @foreach($blogCategories as $cat)
                        <a href="{{ route('front.news', ['category' => $cat->slug ?? $cat->id]) }}" class="nd-cat-item">
            ...
            <div class="nd-panel">
                <div class="nd-panel-head">
                    <div class="nd-panel-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/></svg></div>
    ...
    <div class="nd-related-section">
        <div class="nd-related-head">
            ...
            <a href="{{ route('front.news') }}" class="nd-see-all">
                All articles
    ...
    <div class="container">
        <div class="nd-cta-inner">
            ...
            <div class="nd-cta-btns">
                ...
                <a href="{{ route('front.news') }}" class="nd-cta-btn nd-btn-ghost">
