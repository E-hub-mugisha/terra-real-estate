...
<div class="sl-wrap">
    ...
    <div class="sl-left">
        ...
        <div class="sl-copy">
            <div class="sl-copy-tag">Account Recovery</div>
            <h2 class="sl-headline">
                Reset your <em>secure access</em><br>in seconds.
            </h2>
            <p class="sl-subline">
        ...
        <div class="sl-stats">
            <div>
                <div class="sl-stat-val">100<span>%</span></div>
                <div class="sl-stat-label">Secure Process</div>
            </div>
            <div>
                <div class="sl-stat-val">24/7</div>
                <div class="sl-stat-label">Support</div>
            </div>
            <div>
                <div class="sl-stat-val">Fast</div>
                <div class="sl-stat-label">Recovery</div>
            </div>
        </div>
    </div>
    ...
    <div class="sl-right">
        <div class="sl-form-box">
            ...
            <div class="sl-form-head">
                <div class="pre-label">✦ Password Reset</div>
