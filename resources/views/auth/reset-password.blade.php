...
<div class="sl-wrap">
    ...
    <div class="sl-left">
        ...
        <div class="sl-copy">
            <div class="sl-copy-tag">Security Update</div>
            <h2 class="sl-headline">
                Create a <em>strong new password</em><br>for your account.
            </h2>
            <p class="sl-subline">
                Make sure your new password is unique and secure.
                This helps keep your account protected at all times.
            </p>
        </div>

        <div class="sl-stats">
            <div>
                <div class="sl-stat-val">256-bit</div>
                <div class="sl-stat-label">Encryption</div>
            </div>
            <div>
                <div class="sl-stat-val">Secure</div>
                <div class="sl-stat-label">Process</div>
            </div>
            <div>
                <div class="sl-stat-val">Trusted</div>
                <div class="sl-stat-label">Platform</div>
            </div>
        </div>
    </div>
    ...
    <div class="sl-right">
        <div class="sl-form-box">
            ...
            <div class="sl-form-head">
                <div class="pre-label">✦ Reset Password</div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                {{-- Email --}}
                <div class="sl-field">
                    <label class="sl-label">Email Address</label>
                ...
                {{-- Password --}}
                <div class="sl-field">
                    <label class="sl-label">New Password</label>
                    <div class="sl-input-wrap">
                        <span class="field-icon">🔒</span>
                        <input type="password"
                               name="password"
