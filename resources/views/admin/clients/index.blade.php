...
.page-header-left h1 {
    font-size: 1.55rem; font-weight: 800; color: var(--text); margin: 0 0 4px;
}
.page-header-left h1 em { font-style: normal; color: var(--tp); }
...
.stat-card .stat-label { font-size: 11px; font-weight: 700; text-transform: uppercase;
    letter-spacing: .06em; color: var(--muted); margin-bottom: 6px; }
.stat-card .stat-value { font-size: 1.7rem; font-weight: 800; color: var(--text); line-height: 1; }
.stat-card .stat-sub { font-size: 12px; color: var(--muted); margin-top: 4px; }
.stat-card.green  { border-left: 4px solid var(--tp); }
...
.toolbar-search input:focus { border-color: var(--tp); }
.toolbar-search svg {
...
.toolbar-select:focus { border-color: var(--tp); }
...
.btn-terra {
    ...
    background: var(--tp); color: var(--white); font-size: 14px; font-weight: 600;
...
.btn-outline-terra {
    ...
    background: transparent; color: var(--tp); font-size: 13px; font-weight: 600;
    padding: 7px 14px; border-radius: 7px; border: 1.5px solid var(--tp);
    cursor: pointer; transition: all .2s; text-decoration: none;
}
.btn-outline-terra:hover { background: var(--tp); color: var(--white); }
.btn-danger-sm {
    display: inline-flex; align-items: center; gap: 5px;
    background: transparent; color: var(--danger); font-size: 12px; font-weight: 600;
    padding: 5px 11px; border-radius: 6px; border: 1.5px solid #fca5a5;
    cursor: pointer; transition: all .2s;
}
.btn-danger-sm:hover { background: var(--danger); color: var(--white); border-color: var(--danger); }
.btn-view-sm {
    display: inline-flex; align-items: center; gap: 5px;
    background: #f0faf5; color: var(--tp); font-size: 12px; font-weight: 600;
    padding: 5px 11px; border-radius: 6px; border: 1px solid var(--tp-border);
    text-decoration: none; transition: all .2s;
}
.btn-view-sm:hover { background: var(--tp); color: var(--white); }
.btn-edit-sm {
    display: inline-flex; align-items: center; gap: 5px;
    background: #fffbeb; color: #92400e; font-size: 12px; font-weight: 600;
    padding: 5px 11px; border-radius: 6px; border: 1px solid #fde68a;
    cursor: pointer; transition: all .2s;
}
.btn-edit-sm:hover { background: var(--accent); color: var(--white); border-color: var(--accent); }
...
.clients-table thead th.sortable:hover { color: var(--tp); }
.clients-table tbody tr {
    border-bottom: 1px solid var(--border); transition: background .15s;
}
.clients-table tbody tr:last-child { border-bottom: none; }
.clients-table tbody tr:hover { background: #fafcfb; }
.clients-table td { padding: 13px 16px; font-size: 14px; vertical-align: middle; }
...
.client-nid  { font-size: 11px; color: var(--muted); margin-top: 2px; }

.type-badge {
    display: inline-block; padding: 3px 10px; border-radius: 999px;
    font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .04em;
}
.type-owner     { background: #d1fae5; color: #065f46; }
.type-agent     { background: #dbeafe; color: #1e40af; }
.type-developer { background: #ede9fe; color: #5b21b6; }
.type-company   { background: #fef3c7; color: #92400e; }
...
/* ─── Pagination ──────────────────────────────────────────── */
.pagi-wrap { padding: 16px 18px; border-top: 1px solid var(--border); display: flex;
...
.pagi-wrap .page-link {
    ...
    color: var(--tp); border-color: var(--border); padding: 6px 12px;
}
.pagi-wrap .page-item.active .page-link {
    background: var(--tp); border-color: var(--tp); color: var(--white);
}
...
.modal-header .modal-title { color: var(--white); font-size: 16px; font-weight: 700; }
.modal-header .btn-close { filter: invert(1); opacity: .8; }
.modal-body { padding: 22px; }
.modal-footer { padding: 14px 22px; border-top: 1px solid var(--border); background: var(--bg); }

.form-label-terra {
    font-size: 12px; font-weight: 700; text-transform: uppercase;
    letter-spacing: .06em; color: var(--muted); margin-bottom: 6px; display: block;
}
.form-control-terra, .form-select-terra {
    width: 100%; padding: 9px 13px; border: 1.5px solid var(--border);
    border-radius: 8px; font-size: 14px; color: var(--text);
    background: var(--white); outline: none; transition: border-color .2s;
    font-family: inherit;
}
.form-control-terra:focus, .form-select-terra:focus {
    border-color: var(--tp); box-shadow: 0 0 0 3px rgba(44,110,73,.1);
}
.form-control-terra.is-invalid, .form-select-terra.is-invalid {
...
.form-section-title {
    ...
    letter-spacing: .07em; color: var(--muted); padding-bottom: 8px;
    border-bottom: 1px solid var(--border); margin: 18px 0 14px;
}

/* Delete modal */
.delete-modal .modal-header { background: linear-gradient(135deg, #dc2626, #b91c1c); }
.delete-warning {
    background: var(--danger-lt); border: 1px solid #fca5a5;
    border-radius: 8px; padding: 14px 16px; font-size: 14px; color: #7f1d1d;
    margin-bottom: 16px;
}
.delete-confirm-info {
...
.delete-confirm-name { font-weight: 700; font-size: 15px; color: var(--text); }
.delete-confirm-sub  { font-size: 13px; color: var(--muted); margin-top: 2px; }
.btn-confirm-delete {
...
document.getElementById('addClientForm').addEventListener('submit', function (e) {
    if (!validateForm('add')) { e.preventDefault(); return; }
