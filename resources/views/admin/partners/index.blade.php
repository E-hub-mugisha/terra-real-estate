...
<style>
    ...
    .pt-stat::before {
        ...
        width: 3px;
        height: 100%;
        background: var(--bc, var(--emerald));
    }

    .pt-stat-val {
        font-size: 1.5rem;
        font-weight: 700;
        color: var(--bc, var(--emerald));
        line-height: 1;
    }
    ...
    .pt-search {
        width: 100%;
        padding: .48rem .75rem .48rem 2.15rem;
        border: 1.5px solid var(--border);
        border-radius: 8px;
        font-size: .82rem;
        color: var(--text);
    ...
    .pt-current-img-info strong {
        display: block;
        font-size: .83rem;
        color: var(--text);
    }

    .pt-current-img-info span {
        font-size: .73rem;
        color: var(--muted);
    }
    ...
    <div class="pt-card">
        <div class="pt-card-toolbar">
            <div class="pt-card-title">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="color:var(--emerald)">
            ...
            <table class="pt-table">
                ...
                <tbody id="ptBody">
                    ...
                    <tr data-name="{{ strtolower($partner->name) }}">
                        <td>
                            <div class="pt-idx">{{ $loop->iteration }}</div>
                        </td>
                        <td>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="pt-file-zone" id="createDropZone">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color:var(--emerald);margin-bottom:.4rem">
                            <rect width="18" height="18" x="3" y="3" rx="2" />
                            <circle cx="9" cy="9" r="2" />
                            <path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" />
                        </svg>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="pt-file-zone">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color:var(--emerald);margin-bottom:.35rem">
