...
<style>
    ...
    .ad-stat-value.accent {
        color: var(--accent);
    }

    .ad-stat-value.success {
        color: var(--success);
    }
    ...
    .ad-search-input {
        width: 100%;
        padding: .58rem .85rem .58rem 2.3rem;
        border: 1.5px solid var(--border);
        border-radius: 8px;
        font-size: .84rem;
        color: var(--text);
