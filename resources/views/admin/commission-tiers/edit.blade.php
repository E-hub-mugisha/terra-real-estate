...
<div class="container py-5">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 fw-bold mb-1" style="color:var(--terra-navy)">Edit Commission Tier</h1>
            <p class="text-muted mb-0" style="font-size:.9rem">{{ $commissionTier->label }}</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.commission-tiers.update', $commissionTier) }}">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="label" class="form-control"
                                value="{{ old('label', $commissionTier->label) }}" required>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="min_value" class="form-control"
                                        value="{{ old('min_value', $commissionTier->min_value) }}"
                                        min="0" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_value" class="form-control"
                                        value="{{ old('max_value', $commissionTier->max_value) }}"
                                        min="0">
                                    <span class="input-group-text" style="font-size:.8rem">RWF</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="terra_commission_pct" id="terraPct"
                                        class="form-control"
                                        value="{{ old('terra_commission_pct', $commissionTier->terra_commission_pct) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="consultant_payout_pct" id="consultantPct"
                                        class="form-control"
                                        value="{{ old('consultant_payout_pct', $commissionTier->consultant_payout_pct) }}"
                                        min="0" max="100" step="0.01" required>
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div style="height:10px;border-radius:5px;overflow:hidden;background:rgba(255,255,255,.1);display:flex">
                                <div id="terraBar" style="height:100%;background:linear-gradient(90deg,var(--terra-orange),var(--terra-gold));transition:width .3s"></div>
                                <div id="consultantBar" style="height:100%;background:linear-gradient(90deg,#2d7a4f,#5ddc8a);transition:width .3s"></div>
                            </div>
                            <div style="display:flex;justify-content:space-between;margin-top:6px">
                                <span id="terraBarPct" style="font-size:.75rem;color:var(--terra-gold);font-weight:600"></span>
                                <span id="consultantBarPct" style="font-size:.75rem;color:#5ddc8a;font-weight:600"></span>
                            </div>
                        </div>
                        ...
                        <div style="border-top:1px solid rgba(255,255,255,.1);padding-top:16px">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span id="terraAmt" style="font-size:.82rem;color:var(--terra-gold);font-weight:600"></span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span style="font-size:.82rem;color:rgba(255,255,255,.5)">Consultant Gets</span>
                                <span id="consultantAmt" style="font-size:.82rem;color:#5ddc8a;font-weight:600"></span>
                            </div>
                        </div>
...
<script>
    ...
    // Run on load with existing values
    updatePreview();
</script>
@endsection