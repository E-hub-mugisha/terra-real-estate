...
<style>
    ...
    .hp-input.is-invalid, .hp-select.is-invalid, .hp-textarea.is-invalid {
    ...
    .hp-dropzone:hover, .hp-dropzone.dragover {
        border-color: var(--accent);
        background: #D0520807;
    }
    .hp-dropzone input {
    ...
    @media(max-width:600px) { .hp-pkg-row { grid-template-columns: 1fr; } }
...
<div class="hp-page">
    ...
    <form method="POST" action="{{ route('admin.properties.houses.store') }}" enctype="multipart/form-data" id="houseForm">
        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-input-group">
                                    <input type="number" name="area_sqft"
                                        ...
                                        placeholder="0" min="1" value="{{ old('area_sqft') }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms',1) }}" min="0" max="20" required>
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('bedrooms',1)">+</button>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms',1) }}" min="0" max="20" required>
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('bathrooms',1)">+</button>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="hp-counter">
                                    ...
                                    <input type="number" name="garages" id="garages" value="{{ old('garages',0) }}" min="0" max="10">
                                    <button type="button" class="hp-counter-btn" onclick="stepCounter('garages',1)">+</button>
                                </div>
...
(function () {
    ...
    function renderPreview(src, idx) {
        ...
        d.dataset.idx = idx;
        d.innerHTML = `<img src="${src}" alt=""><button type="button" class="hp-preview-remove" onclick="removePreview(${idx})">✕</button>`;
